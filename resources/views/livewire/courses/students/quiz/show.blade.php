                    ...
                    <div class="bg-white shadow-md rounded-md overflow-hidden p-5">
                        ...
                        <h2 class="font-bold text-lg mb-2">{{ $quiz->name }}</h2>
                            ...
                            <div class="flex justify-end mt-6">
                                <button type="submit" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-pequant-blue-600 border border-transparent rounded-lg active:pequant-blue-600 hover:pequant-blue-700 focus:outline-none">Submit Score</button>
                            </div>
                        </form>
                    </div>
                </div>
