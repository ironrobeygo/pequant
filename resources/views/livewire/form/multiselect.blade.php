<div>
    ...
    <div x-data="dropdown()" x-init="loadOptions()" class="w-full">
        <input type="hidden" wire:model="selectedOption">
        <div class="w-64 relative">
            <div class="flex flex-col items-center relative">
                <div x-on:click="open" class="w-full">
                    <div class="my-2 p-1 flex border border-gray-200 bg-white rounded">
                        <div class="flex flex-auto flex-wrap">
                            ...
                            <div x-show="selected.length == 0" class="flex-1" style="display: none;">
                ...
                <div class="w-full px-4">
                    <div x-show.transition.origin.top="isOpen()" class="absolute shadow top-100 bg-white z-40 w-full left-0 rounded max-h-select overflow-y-auto" x-on:click.away="close" style="display: none;">
