<x-app-layout>
    <x-slot name="header">
        ...
        <div class="lg:flex md:flex justify-items lg:space-x-2 md:space-x-2">
            <a href="{{ route('institutions') }}" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-pequant-blue-600 border border-transparent rounded-lg active:pequant-blue-600 hover:pequant-blue-700 focus:outline-none">
            ...
            <a href="/institutions/{{ $institution->id }}/edit" class="flex items-center justify-between px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-pequant-blue-600 border border-transparent rounded-lg active:pequant-blue-600 hover:pequant-blue-700 focus:outline-none">
    ...
    @livewire('institution.show', ['institution' => $institution])
</x-app-layout>
