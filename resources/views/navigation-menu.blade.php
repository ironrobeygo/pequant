    ...
    <div class="py-4 text-gray-500 text-gray-400">
        ...
        <ul>
            ...
            <x-jet-nav-link href="{{ route('activities') }}" :active="request()->routeIs('activities')">
                ...
                <span class="ml-4">{{ __('Activity Log') }}</span>
            </x-jet-nav-link>
            @endhasrole
            ...
            <x-jet-nav-link href="/analytics" :active="request()->routeIs('analytics')">
                ...
                <span class="ml-4">{{ __('Analytics') }}</span>
            </x-jet-nav-link>
            ...
            <x-jet-nav-link href="/events" :active="request()->routeIs('events')">
                ...
                <span class="ml-4">{{ __('Events') }}</span>
            </x-jet-nav-link>
...
<div x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="fixed inset-0 z-10 flex items-end bg-opacity-50 sm:items-center sm:justify-center" style="display: none;"></div>

<aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white md:hidden" x-show="isSideMenuOpen" x-transition:enter="transition ease-in-out duration-150" x-transition:enter-start="opacity-0 transform -translate-x-20" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in-out duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 transform -translate-x-20" @click.away="isSideMenuOpen=false" @keydown.escape="isSideMenuOpen=false" style="display: none;">
    <div class="py-4 text-gray-500 text-gray-400">
        <x-jet-authentication-card-logo />
        <ul class="mt-6">
            <x-jet-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
